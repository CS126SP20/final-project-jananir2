...
DEFINE_string(filename1, "quiz1.csv", "the name of the first quiz file");
DEFINE_string(filename2, "quiz2.csv", "the name of the second quiz file");
DEFINE_string(filename3, "quiz3.csv", "the name of the third quiz file");
